...
Page({
  data: {
    serviceName: '林夏',
    promptItems: [
      { title: '首次租房', desc: '先控预算', text: '我第一次租房，想先控制月租和通勤时间。' },
      { title: '近地铁', desc: '通勤优先', text: '请优先帮我筛选近地铁、步行可达的待租房源。' },
      { title: '整租两居', desc: '两人居住', text: '我想找整租两居，最好拎包入住。' },
      { title: '押一付一', desc: '付款轻松', text: '请优先推荐押一付一、预算友好的房源。' },
      { title: '可养宠物', desc: '宠物友好', text: '我有宠物，请优先筛选可养宠物的房源。' },
      { title: '预算不确定', desc: '先定范围', text: '我预算还不太确定，请先帮我倒推出合适的租房范围。' },
    ] as PromptItem[],
    messages: [
      {
        id: 'welcome',
        role: 'assistant',
        content: '告诉我预算、区域和通勤，我来帮你筛选。',
        timestamp: Date.now(),
      },
    ] as ChatMessageItem[],
    ...
    followUps: ['近地铁', '3000以内', '押一付一', '可养宠物'],
